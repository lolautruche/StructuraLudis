    ...
    async with AsyncSessionLocal() as session:
        ...
        safety_tools = [
            SafetyToolEntity(
                ...
                name_i18n={"en": "X-Card", "fr": "X-Card"},
                description_i18n={
                    "en": "Allows to signal discomfort without explanation",
                    "fr": "Permet de signaler un malaise sans explication",
                },
                is_required=False,
                display_order=1,
            ),
            SafetyToolEntity(
                ...
                name_i18n={"en": "Lines & Veils", "fr": "Lignes et Voiles"},
                description_i18n={
                    "en": "Define hard limits and what is only suggested",
                    "fr": "Définir les limites et ce qu'on suggère seulement",
                },
                is_required=False,
                display_order=2,
            ),
            SafetyToolEntity(
                ...
                name_i18n={"en": "Script Change", "fr": "Changement de Script"},
                description_i18n={
                    "en": "Pause, fast forward, rewind",
                    "fr": "Pause, avance rapide, retour arrière",
                },
                is_required=False,
                display_order=3,
            ),
        ...
        for day_offset in range(3):
            ...
            # === Espace JdR: Classic RPG slots (3 per day) ===
            ...
            # Evening: 20:00-01:00, max 300min (except Sunday)
            if day_offset < 2:
        ...
        # rpg_slots: 8 slots (3 days × 2-3 per day, no evening on Sunday)
        # singes_slots: 6 slots (3 days × 2 per day)
        # board_slots: 9 slots (3 days × 3 per day)
        zone_slots_map = {
            "rpg": rpg_slots,
            "singes": singes_slots,
            "board": board_slots,
        ...
        sessions_data = [
            ...
            # Session 0: Cthulhu - 2 players (3 available) - Friday Morning
            {
                "game": cthulhu,
                "gm": gm1,
                "title": "Les Masques de Nyarlathotep - Prologue",
                "zone": "rpg",
                "slot_idx": 0,  # Friday Morning
                "table": rpg_tables[0],
            ...
            # Session 1: D&D - FULL with waitlist - Friday Afternoon
            {
                "game": dnd,
                "gm": gm2,
                "title": "La Malédiction de Strahd - Chapitre 1",
                "zone": "rpg",
                "slot_idx": 1,  # Friday Afternoon
                "table": rpg_tables[1],
                "status": SessionStatus.VALIDATED,
                "max_players": 4,
                "safety_tools": ["x-card"],
            ...
            # Session 2: Alien - Almost full (4/5) - Friday Evening
            {
                "game": alien,
                "gm": gm1,
                "title": "Chariot of the Gods",
                "zone": "rpg",
                "slot_idx": 2,  # Friday Evening
                "table": rpg_tables[2],
                "status": SessionStatus.VALIDATED,
                "max_players": 5,
            ...
            # Session 3: COF - Beginner friendly, half full - Saturday Morning
            {
                "game": cof,
                "gm": gm2,
                "title": "Initiation : Le Donjon de Donjons",
                "zone": "rpg",
                "slot_idx": 3,  # Saturday Morning
                "table": rpg_tables[3],
                "status": SessionStatus.VALIDATED,
                "max_players": 6,
                "safety_tools": ["x-card"],
            ...
            # Session 4: Pénombre - 3 players - Saturday Afternoon
            {
                "game": penombre,
                "gm": gm1,
                "title": "L'Affaire du Vampire de Düsseldorf",
                "zone": "rpg",
                "slot_idx": 4,  # Saturday Afternoon
                "table": rpg_tables[4],
                "status": SessionStatus.VALIDATED,
                "max_players": 4,
                "safety_tools": ["x-card", "lines-veils"],
            ...
            # Session 5: Maléfices by Arkhane partner - Saturday Evening
            {
                "game": malefices,
                "gm": partner_arkhane,
                "title": "Le Fantôme de l'Opéra",
                "zone": "rpg",
                "slot_idx": 5,  # Saturday Evening
                "table": rpg_tables[5],
                "status": SessionStatus.VALIDATED,
                "max_players": 5,
                "safety_tools": ["x-card"],
            ...
            # Session 6: Kult - Mature, 2 players - Saturday Evening (different table)
            {
                "game": kult,
                "gm": gm1,
            ...
            # Session 7: Star Wars - Empty (just opened) - Sunday Morning
            {
                "game": starwars,
                "gm": gm2,
                "title": "Contrebande sur Tatooine",
                "zone": "rpg",
                "slot_idx": 6,  # Sunday Morning
                "table": rpg_tables[7],
                "status": SessionStatus.VALIDATED,
                "max_players": 5,
                "safety_tools": ["x-card"],
            ...
            # Session 8: Cats - Family friendly, full - Saturday Morning
            {
                ...
                "zone": "singes",
                "slot_idx": 2,  # Saturday Morning (day 1 × 2 slots)
            ...
            # === IN_PROGRESS SESSION ===
            # Session 10: In progress with checked-in players - Friday Morning
            {
                "game": cthulhu,
                "gm": gm1,
